...
export const login = (userData) => {
  return axios.post("https://quickly-healthy-be.onrender.com/api/users/login", userData);
};
...
export const currentUser = () => {
  return axios.get("https://quickly-healthy-be.onrender.com/api/users/current");
}
...
export const fetchUser = userId => {
  return axios.get(`https://quickly-healthy-be.onrender.com/api/users/${userId}`);
}
